...
<form action="index.php?do=doimatkhau_xuly" method="post" style="border:1px solid #ccc">
  <div class="container">
    <h1>Đổi mật khẩu</h1>
    <p>Mật khẩu tài khoản của bạn, Bạn có thể cập nhật !!!</p>
    <hr>
    ...
    <div class="clearfix">
      ...
      <button type="submit" class="signupbtn" >Cập nhật mật khẩu</button>
    </div>
  </div>
</form>
